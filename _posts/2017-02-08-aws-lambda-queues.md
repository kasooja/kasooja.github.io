...
7. [Trigger Lambda from SQS](https://forums.aws.amazon.com/message.jspa?messageID=698761)
8. [Git Repo: SQS to Lambda via Lambda](https://github.com/zwily/sqs-to-lambda-via-lambda)
9. [Git Repo: SQS to Lambda](https://github.com/robinjmurphy/sqs-to-lambda)
10. [Invoking Lambda with SNS](http://docs.aws.amazon.com/sns/latest/dg/sns-lambda.html)
11. [S3 Bucket Notification to SQS/SNS on Object Creation](https://alestic.com/2014/12/s3-bucket-notification-to-sqssns-on-object-creation/)
